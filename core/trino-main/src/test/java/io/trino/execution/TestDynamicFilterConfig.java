...
public class TestDynamicFilterConfig
{
    ...
    public void testDefaults()
    {
        assertRecordedDefaults(recordDefaults(DynamicFilterConfig.class)
                ...
                .setBitmapMaxDistinctValuesPerDriver(75_000)
                .setPartitionedBitmapMaxDistinctValuesPerDriver(25_000));
    }
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = ImmutableMap.<String, String>builder()
                ...
                .put("dynamic-filtering.bitmap.max-distinct-values-per-driver", "15000")
                .put("dynamic-filtering.partitioned-bitmap.max-distinct-values-per-driver", "5000")
                .buildOrThrow();
        ...
        DynamicFilterConfig expected = new DynamicFilterConfig()
                ...
                .setBitmapMaxDistinctValuesPerDriver(15000)
                .setPartitionedBitmapMaxDistinctValuesPerDriver(5000);
